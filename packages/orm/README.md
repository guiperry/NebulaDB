...
ORM-style modeling for NebulaDB - Define database models using TypeScript decorators.
...
```bash
npm install @nebula-db/orm @nebula-db/core
```

## Quick Start

```typescript
import { Model, Field, Index } from '@nebula-db/orm';
...
Defines a class as a NebulaDB model.
